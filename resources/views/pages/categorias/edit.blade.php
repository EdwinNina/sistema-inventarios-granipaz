        ...
        <div class="grid grid-cols-12 gap-6">
            <div class="col-span-full bg-white shadow-lg rounded-sm border border-gray-200">
                <header class="px-5 py-4 border-b border-gray-100 flex justify-between items-center">
                    <h2 class="font-semibold text-gray-800">Editar Categoria</h2>
                ...
                <div class="px-4 pb-4 mt-4">
                    <form action="{{ route('categorias.update', $categoria->id) }}" method="post">
                        ...
                        <div class="form-control w-full">
                            ...
                            <input type="text" placeholder="Ingrese la categoria" class="input input-bordered w-full @error('nombre') input-error @enderror" name="nombre" value="{{ $categoria->nombre }}" />
                        ...
                        <div class="form-control w-full">
                            ...
                            <input type="text" placeholder="Ingrese la descripcion" class="input input-bordered w-full" name="descripcion" value="{{ $categoria->descripcion }}" />
                        </div>
                        @livewire('sub-categoria-component', ['a_subcategorias' => $categoria->subcategorias->toArray()])
