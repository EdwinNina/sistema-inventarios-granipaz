        ...
        <div class="grid grid-cols-12 gap-6">
            <div class="col-span-full bg-white shadow-lg rounded-sm border border-gray-200">
                <header class="px-5 py-4 border-b border-gray-100 flex justify-between items-center">
                    <h2 class="font-semibold text-gray-800">Registrar Nueva Compra</h2>
                ...
                <div class="px-4 pb-4 mt-4">
                    <form action="{{ route('compras.store') }}" method="post">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text"
                                        ...
                                        @error('fecha') input-error @enderror"
                                        placeholder="Select date" name="fecha" value="{{ \Carbon\Carbon::now()->format('d-m-Y') }}">
                                    @error('fecha')
                        ...
                        @livewire('productos-carrito-component', ['tipo' => 'compra'])
